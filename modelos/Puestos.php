...
class Empleado extends Conexion{
    ...
    public function guardar(){
        $sql = "INSERT INTO empleados(emp_nombre, emp_dpi, emp_puesto, emp_edad, emp_sexo) values('$this->emp_nombre','$this->emp_dpi', '$this->emp_puesto','$this->emp_edad','$this->emp_sexo')";
        $resultado = self::ejecutar($sql);
        return $resultado;
    }

    public function buscar(){
        $sql = "SELECT * from empleados where emp_puesto = 1 ";
        ...
        if($this->emp_puesto != ''){
            $sql .= " and emp_puesto = $this->emp_puesto ";
        }
