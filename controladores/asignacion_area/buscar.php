...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php if(count($asignacion_areas) > 0):?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4">
                <a href="/final_bolvito/vistas/asignacion_areas/buscar.php" class="btn btn-info w-100">Volver al formulario</a>
            </div>
        </div>
    </div>
</body>
